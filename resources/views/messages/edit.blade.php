...
<div class="mt-5 col-sm-6 mx-auto">
    ...
    <form action="{{ route('messages.update', ['message' => $message -> id]) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input value="{{ $message->message_body }}" name="message_body" type="text" class="form-control" id="message_body">
        ...
        <div class="form-group">
            ...
            <input value="{{ $message->from_id }}" name="from_id" type="text" class="form-control" id="from_id">
        ...
        <div class="form-group">
            ...
            <input value="{{ $message->to_id }}" name="to_id" type="text" class="form-control" id="to_id">
            @if ($errors->has('to_id'))
