...
<div class="mt-5 col-sm-6 mx-auto">
    ...
    <form action="{{ route('sales.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input value="{{ @old('buyer_id') }}" name="buyer_id" type="number" class="form-control" id="buyer_id">
        ...
        <div class="form-group">
            ...
            <input value="{{ @old('seller_id') }}" name="seller_id" type="number" class="form-control" id="seller_id">
